...
## 🔖 Project Layout
https://github.com/MvriloNascimento/Food-Explorer-Back-End-/blob/main/public/Homepage.png?raw=true
<br>
<br>
...
```bash
  $ https://github.com/Ev4ndr0w/Food-Explorer-Back-End-.git
```

- Enter the directory:

```bash 
  $ cd + sua pasta + git clone https://github.com/Ev4ndr0w/Food-Explorer-Back-End-.git
```
